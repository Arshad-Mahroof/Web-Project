...
// Fetch only services where service_name is 'Restaurants'
...
$params = ["Restaurants"];
$types = "s"; // s = string for 'Restaurants'
...
<head>
    ...
    <title>Restaurants Services</title>
...
<h2 class="title">Restaurants Services</h2>

<section class="bookings">
    <h3 class="booking-title">All Restaurants Provider Booking Dates:</h3>
    <?php
