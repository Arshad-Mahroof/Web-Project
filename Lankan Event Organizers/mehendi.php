...
// Fetch only services where service_name is 'Mehandi Artists'
$stmt = $conn->prepare("SELECT * FROM services WHERE service_name = ?");
$service_name = "Mehandi Artists";
...
$params = ["Mehandi Artists"];
$types = "s"; // s = string for 'Mehandi Artists'
...
<head>
    ...
    <title>Mehandi Artists Services</title>
...
<h2 class="title">Mehandi Artists Services</h2>

<section class="bookings">
    <h3 class="booking-title">All Mehandi Artists Provider Booking Dates:</h3>
    <?php
