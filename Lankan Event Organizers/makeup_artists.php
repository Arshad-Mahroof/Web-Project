...
// Fetch only services where service_name is 'Makeup Artists'
$stmt = $conn->prepare("SELECT * FROM services WHERE service_name = ?");
$service_name = "Makeup Artists";
...
$params = ["Makeup Artists"];
$types = "s"; // s = string for 'Makeup Artists'
...
<head>
    ...
    <title>Makeup Artists Services</title>
...
<h2 class="title">Makeup Artists Services</h2>

<section class="bookings">
    <h3 class="booking-title">All Makeup Artists Provider Booking Dates:</h3>
    <?php
