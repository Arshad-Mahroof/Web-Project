...
// Fetch only services where service_name is 'Cleaning Services'
...
$params = ["Cleaning Services"];
$types = "s"; // s = string for 'Cleaning Services'
...
<section class="bookings">
    <h3 class="booking-title">All Cleaning Provider Booking Dates:</h3>
    <?php
