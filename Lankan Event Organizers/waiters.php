...
// Fetch only services where service_name is 'Waiters'
$stmt = $conn->prepare("SELECT * FROM services WHERE service_name = ?");
$service_name = "Waiters";
...
<h2 class="title">Waiters Services</h2>

<section class="bookings">
    <h3 class="booking-title">All Waiters Provider Booking Dates:</h3>
    <?php
