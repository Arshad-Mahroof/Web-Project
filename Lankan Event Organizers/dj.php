...
// Fetch only services where service_name is 'DJs'
...
<h2 class="title">DJs Services</h2>

<section class="bookings">
    <h3 class="booking-title">All DJs Provider Booking Dates:</h3>
    <?php
