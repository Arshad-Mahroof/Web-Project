...
// Fetch only services where service_name is 'Photographers'
$stmt = $conn->prepare("SELECT * FROM services WHERE service_name = ?");
$service_name = "Photographers";
...
$params = ["Photographers"];
$types = "s"; // s = string for 'Photographers'
...
<head>
    ...
    <title>Photographers Services</title>
...
<h2 class="title">Photographers Services</h2>

<section class="bookings">
    <h3 class="booking-title">All Photographers Provider Booking Dates:</h3>
    <?php
