...
// Get package details from package ID (passed via POST or GET)
...
<head>
    ...
    <title>Lankan Event Organizers - Payment</title>
...
<body>
    ...
    <form action="process_packages_payment.php" method="POST">
        <div class="payment-container">
            ...
            <div class="payment-form">
                ...
                <div class="input-box">
                    <input type="text" name="amount" value="<?php echo $package['price']; ?>" readonly>
            ...
            <div class="service-info">
                ...
                <div class="service-info-header">
                    <div>
                        <strong><?php echo $package['package_type']; ?></strong>
                    </div>
                </div>
                <table class="service-details-table">
                    <tr>
                        <td>Price:</td>
                        <td>LKR <?php echo number_format($package['price'], 2); ?></td>
                    </tr>
                </table>
