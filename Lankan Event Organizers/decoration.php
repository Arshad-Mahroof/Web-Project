...
// Fetch only services where service_name is 'Decorators'
...
$params = ["Decorators"];
$types = "s"; // s = string for 'Decorators'
...
<head>
    ...
    <title>Decorators Services</title>
...
<h2 class="title">Decorators Services</h2>

<section class="bookings">
    <h3 class="booking-title">All Decorators Provider Booking Dates:</h3>
    <?php
